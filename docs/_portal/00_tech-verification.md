...
作成日: 2026-06-15
対象: kuroda-tools F1 プロジェクト初期化の★技術検証3点（plan §4 U-02）
...
|---|---|---|
| **プロジェクト独立性** | ◎ kuroda-tools は独立 git リポ・独立 Vite。本体を触らず完結（plan §2-5「本体は触らない」と完全整合） | ✕ 共有ディレクトリの所有者・参照パスを跨ぎ、独立リポ前提が崩れる |
